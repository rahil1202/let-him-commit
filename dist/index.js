...
async function main() {
    try {
        ...
        const { token, repoName, startDate, endDate, minCommitsPerDay, maxCommitsPerDay, commitTemplate, batchSize } = parsed.data;
        ...
        console.log(chalk.cyan(`📅 Total commits to make: ${schedule.length} (range ${minCommitsPerDay}-${maxCommitsPerDay}/day)`));
